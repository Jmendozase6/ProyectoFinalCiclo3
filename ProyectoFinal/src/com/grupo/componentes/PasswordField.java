...
public class PasswordField extends JPasswordField {
    ...
    private Color lineColor = new Color(53, 211, 164);
    ...
    public PasswordField() {
        ...
        setSelectionColor(new Color(53, 211, 164));
        ...
        eye = new ImageIcon(getClass().getResource("/com/grupo/componentes/imagenes/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/com/grupo/componentes/imagenes/eye_hide.png")).getImage();
    ...
    private void createHintText(Graphics2D g2) {
        Insets in = getInsets();
        g2.setColor(new Color(53, 60, 77)); //Color del label
